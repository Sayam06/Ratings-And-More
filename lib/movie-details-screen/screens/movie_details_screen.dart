...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  Future getData(String id) async {
    ...
    String movieDataUrl = "https://api.themoviedb.org/3/movie/" + id + "?api_key={key}&language=en-US";
    String castDataUrl = "https://api.themoviedb.org/3/movie/" + id + "/credits?api_key={key}&language=en-US";
    String recommendedMoviesUrl = "https://api.themoviedb.org/3/movie/" + id + "/recommendations?api_key={key}&language=en-US&page=1";
    String similarMoviesUrl = "https://api.themoviedb.org/3/movie/" + id + "/similar?api_key={key}&language=en-US&page=1";
